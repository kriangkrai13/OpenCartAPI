...
namespace OpenCart.FactoryClasses
{
	...
	{
		private readonly OpenCart.EntityType _typeOfEntity;
		...
		public EntityFactoryBase2(string entityName, OpenCart.EntityType typeOfEntity, bool isInHierarchy) : base(entityName)
		{
		...
		/// <inheritdoc/>
		public override IEntity2 CreateEntityFromEntityTypeValue(int entityTypeValue) {	return GeneralEntityFactory.Create((OpenCart.EntityType)entityTypeValue); }
	...
	{
		/// <summary>CTor</summary>
		public UserEntityFactory() : base("UserEntity", OpenCart.EntityType.UserEntity, false) { }
		/// <inheritdoc/>
	...
	public partial class GeneralEntityFactory
	{
		...
		public static IEntity2 Create(OpenCart.EntityType entityTypeToCreate)
		{
	...
	public static class EntityFactoryFactory
	{
		...
		{
			foreach(int entityTypeValue in Enum.GetValues(typeof(OpenCart.EntityType)))
			{
				var factory = GetFactory((OpenCart.EntityType)entityTypeValue);
		...
		/// <summary>Gets the factory of the entity with the OpenCart.EntityType specified</summary>
		/// <param name="typeOfEntity">The type of entity.</param>
		/// <returns>factory to use or null if not found</returns>
		public static IEntityFactory2 GetFactory(OpenCart.EntityType typeOfEntity)
		{
			switch(typeOfEntity)
			{
				case OpenCart.EntityType.UserEntity:
	...
	{
		/// <summary>Gets the factory of the Entity type with the OpenCart.EntityType value passed in</summary>
		...
		{
			return new DynamicRelation(leftOperand, joinType, (OpenCart.EntityType)Enum.Parse(typeof(OpenCart.EntityType), rightOperandEntityName, false), aliasRightOperand, onClause);
		}

		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(string leftOperandEntityName, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation((OpenCart.EntityType)Enum.Parse(typeof(OpenCart.EntityType), leftOperandEntityName, false), joinType, (OpenCart.EntityType)Enum.Parse(typeof(OpenCart.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(IEntityFieldCore leftOperand, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation(leftOperand, joinType, (OpenCart.EntityType)Enum.Parse(typeof(OpenCart.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		protected override IEntityFactoryCore GetFactoryImpl(int entityTypeValue) { return EntityFactoryFactory.GetFactory((OpenCart.EntityType)entityTypeValue); }
